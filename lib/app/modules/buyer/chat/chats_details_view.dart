...
class ChatsDetailsBuyerView extends StatelessWidget {
  Users user;
  String senderId;
  ChatsDetailsBuyerView(this.user,this.senderId,{super.key});
  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        ChatCubit.getCubit(context).getMessage(receiverId: user.id!,senderId:senderId,userType:'Buyer');
